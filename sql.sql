...
insert  into `reports`(`Id`,`FileName`,`FileData`,`PatientEmail`,`Status`,`Key1`) values (1,'Medical Report.txt','�K�OV\\)ο�p��;����k�\Z���Cq�Ν�','malleswar@gmail.com','complete','586613'),(2,'document.txt','��^07��* lFNK��','malleswar@gmail.com','done','366317');
